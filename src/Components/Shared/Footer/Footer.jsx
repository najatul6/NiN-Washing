...
const Footer = () => {
  return (
    <div className="bg-deep-blue py-2">
      <footer className="footer p-10 text-white ">
        <aside>
          <img
            src={brandLogo}
            alt=""
            className="bg-white shadow-deep-blue rounded-2xl shadow-inner"
          />
          <p>Providing reliable washing service since 2024.</p>
        </aside>
        <nav>
          <h6 className="text-lg font-bold text-white">Social</h6>
          <div className="grid grid-flow-col gap-4 text-white-coffee ">
            ...
            <Link to="https://www.youtube.com/@mdnajatulislam8347/featured" target="_blank">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
                height="24"
